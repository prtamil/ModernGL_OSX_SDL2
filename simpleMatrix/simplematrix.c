...
int main()
{
   ...
   while(gameloop_running)
   {
	 ...
	 if(e.type == SDL_QUIT)
      ...
      mat4x4_translate_in_place(world, 0.0f, 0.0f, 0.0f);
      GLuint wloc = glGetUniformLocation(shader_program, "worldMatrix");


      glUseProgram(shader_program);
      glProgramUniformMatrix4fv(shader_program, wloc, 1, GL_FALSE, &world[0][0]);
      //drawing code 
      ...
      mat4x4_identity(world);
      mat4x4_translate_in_place(world, 0.25, 0.25, 0.0f);
